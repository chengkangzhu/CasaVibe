...
const ProductCarousel = ({ h2, children }) => {
	...
	return (
		<div className="product_carousel">
			...
			<div className="products_container" ref={containerRef}>
				{" "}
				{children}{" "}
			</div>
			<div className="hide_scrollbar"></div>
			<button ref={buttonLeftRef} className="left">
				<MdOutlineKeyboardArrowLeft size={24} className="icon" />
			</button>
			<button ref={buttonRightRef} className="right">
